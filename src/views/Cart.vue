                                    ...
                                    <div class="card border-0 bg-light">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between mb-3">
                                                ...
                                                <strong class="text-success">${{ selectedTotal.toFixed(2) }}</strong>
                                            </div>
                                            <div class="d-grid gap-2">
                                                ...
                                                <router-link to="/checkout"
                                                    ...
                                                    @click="saveSelectedItemsToCheckout"
                                                    custom
                                                    v-slot="{ navigate }">
                                                    <button 
                                                        @click="saveSelectedItemsToCheckout(); navigate()"
                                                        class="btn"
